...
class PreprocessStep(BaseStep):
    ...
    def normalize(self, gaussian_std, border_amount, M0, M2, HF_M0, LF_M0, ctx):
        ...
        return M0_ff_video, M2_ff_video, HF_M0_ff, LF_M0_ff
    ...
    def run(self, ctx):
        ...
        M0_ff_video, M2_ff_video, HF_M0_ff, LF_M0_ff = self.normalize(gaussian_std, border_amount, moment0, moment2, HF_M0, LF_M0, ctx)
        ...
        # The DAG contract requires every declared output to exist even when a
        # recording has no configured HF/LF bands.
